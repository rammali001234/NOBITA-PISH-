...
<p align="center">
  ...
  <a href="https://github.com/technicalwhitehat-yt/CookPhish"><img src="https://t.me/classlight"></a>
  <a href="https://t.me/classlight"><img src="https://img.shields.io/badge/Maintained%3F-Yes-brightgreen?style=for-the-badge"></a>
...
CookPhish is a modern and powerful phishing simulation framework. It creates highly realistic fake login pages like Instagram, logs victim data (IP, device, time), simulates 2FA, and runs in a stunning terminal interface.

Made strictly for ethical hacking training, CTFs, and cybersecurity education. Do not use illegally.
...
- Cloudflared and Tunnelmole tunneling support
...
You must clone the repo via Git to enable auto-update functionality.
...
If you start facing any errors while running Cookphish, then run this command. This will solve the problem. If it doesn’t, contact us.
...
[![Telegram Channel](https://img.shields.io/badge/Telegram-Channel-blue?style=for-the-badge&logo=telegram)](https://t.me/classlight)
[![Telegram Contact](https://img.shields.io/badge/Telegram-Contact-blue?style=for-the-badge&logo=telegram)](t.me/nobi4t111)
...
This tool is created strictly for educational and ethical testing purposes. Using CookPhish on unauthorized targets is illegal. The author is not responsible for any misuse or damage caused by this tool. Always get proper authorization before testing.
